...
*	%LET results_path=&base_path.\4_results\environ-epi-rating-dpd18;
*	%LET results_path_img=&base_path.\4_results\environ-epi-rating-dpd18\html_images;
	...
	** both;
	%LET name_base=environ-epi-rating-dpd18_; 
...
** import data;
	* local;
*	proc import 
*			datafile="&base_path.\2_data\rasp-caneb_07b_environ_summ-epi_rating.csv"
...
*** Step 4 ***;
	...
	** RESULTS: cov test p-values > 0.05
...
*** Step 1 ***;
	...
	** CONCLUSIONS: don not use repeated measures	
